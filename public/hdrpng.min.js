...
!(function (e, t, r) {
    'undefined' != typeof module && module.exports ? (module.exports = r()) : 'function' == typeof define && define.amd ? define(e, r) : (t[e] = r())
    ...
    function t() {
        ...
        return (
            ...
            (r.toHDRBlob = function (e, t) {
                ...
                var i = new Uint8Array(t && t.match(/rgb9_e5/i) ? n(h(s)).buffer : s.buffer),
                    o =
                ...
                c.activeTexture(c.TEXTURE0),
                    ...
                    c.texImage2D(c.TEXTURE_2D, 0, c.RGBA, u, d, 0, c.RGBA, c.UNSIGNED_BYTE, new Uint8Array(i.buffer))
                var E = a(c, o, f),
                    T = c.getUniformLocation(E, 'tx'),
                    _ = new Float32Array([-1, -1, 0, 1, -1, 0, 1, 1, 0, 1, 1, 0, -1, 1, 0, -1, -1, 0]),
                    m = c.createBuffer()
                return (
            ...
            r.__defineSetter__('src', function (n) {
                if (((u = n), e && e.clearRect(0, 0, this.width, this.height), n.match(/\.hdr$/i)))
                    a(
                        n,
                        function (r, a, n) {
                            ;(s = r),
                    ...
                    ;(h.src = n),
                        (h.onload = function () {
                            ...
                            u.bindTexture(u.TEXTURE_2D, c),
                                u.texImage2D(u.TEXTURE_2D, 0, u.RGBA, u.RGBA, u.UNSIGNED_BYTE, h),
                    ...
                    ;(h.src = n),
                        (h.onload = function () {
                            ...
                            i.bindTexture(i.TEXTURE_2D, o),
                                i.texImage2D(i.TEXTURE_2D, 0, i.RGBA, i.RGBA, i.UNSIGNED_BYTE, h),
    ...
    function a(e, t) {
        ...
        return (
            ...
            (a.onload = function () {
                ...
                for (var e, r = '', a = 0, n = new Uint8Array(this.response); !r.match(/\n\n[^\n]+\n/g); ) r += String.fromCharCode(n[a++])
                if (((e = r.match(/FORMAT=(.*)$/m)[1]), '32-bit_rle_rgbe' != e)) return console.warn('unknown format : ' + e), this.onerror()
                for (var i = r.split(/\n/).reverse()[1].split(' '), o = 1 * i[3], h = 1 * i[1], f = new Uint8Array(o * h * 4), u = 0, d = 0; h > d; d++) {
                    var l = n.slice(a, (a += 4)),
                        s = []
                    if (2 != l[0] || 2 != l[1] || 128 & l[2]) return console.warn('HDR parse error ..'), this.onerror()
                    if ((l[2] << 8) + l[3] != o) return console.warn('HDR line mismatch ..'), this.onerror()
                    for (var c = 0; 4 > c; c++)
                        for (var g, E, T = c * o, _ = (c + 1) * o; _ > T; )
                            if (((g = n.slice(a, (a += 2))), g[0] > 128)) for (E = g[0] - 128; E-- > 0; ) s[T++] = g[1]
                            else for (E = g[0] - 1, s[T++] = g[1]; E-- > 0; ) s[T++] = n[a++]
                    for (var c = 0; o > c; c++) (f[u++] = s[c]), (f[u++] = s[c + o]), (f[u++] = s[c + 2 * o]), (f[u++] = s[c + 3 * o])
                }
                t && t(f, o, h)
            }),
            a.open('GET', e, !0),
    ...
    function n(e, t) {
        for (var r, a, n, i, o, h, f = (e.byteLength / 12) | 0, t = t || new Uint32Array(f), u = 0; f > u; u++)
            (r = Math.min(32768, e[3 * u])),
                ...
                (t[u] = (Math.floor(r / h + 0.5) << 23) + (Math.floor(a / h + 0.5) << 14) + (Math.floor(n / h + 0.5) << 5) + (0 | o))
        return t
    }
    function i(e, t) {
        for (var r, a, n = e.byteLength >> 2, t = t || new Float32Array(3 * n), i = 0; n > i; i++)
            (r = e[i]),
    ...
    function o(t, r) {
        for (var a, n, i, o, h, f = (t.byteLength / 12) | 0, r = r || new Uint8Array(4 * f), u = 0; f > u; u++)
            (a = t[3 * u]),
                (n = t[3 * u + 1]),
                (i = t[3 * u + 2]),
    ...
    function h(e, t) {
        for (var r, a = e.byteLength >> 2, t = t || new Float32Array(3 * a), n = 0; a > n; n++)
            (r = Math.pow(2, e[4 * n + 3] - 136)), (t[3 * n] = e[4 * n] * r), (t[3 * n + 1] = e[4 * n + 1] * r), (t[3 * n + 2] = e[4 * n + 2] * r)
        return t
    }
    function f(e, t, r, a) {
        ;(t = Math.pow(2, void 0 === t ? 1 : t) / 2), void 0 === r && (r = 2.2)
        for (var n, i = 1 / r, o = e.byteLength >> 2, a = a || new Uint8ClampedArray(4 * o), h = 0; o > h; h++)
    ...
    function u(e, t, r, a) {
        ;(t = Math.pow(2, void 0 === t ? 1 : t) / 2), void 0 === r && (r = 2.2)
        for (var n = 1 / r, i = (e.byteLength / 12) | 0, a = a || new Uint8ClampedArray(4 * i), o = 0; i > o; o++)
    ...
    return (t.floatToRgbe = o), (t.rgbeToFloat = h), (t.floatToRgb9_e5 = n), (t.rgb9_e5ToFloat = i), (t.rgbeToLDR = f), (t.floatToLDR = u), t
})
